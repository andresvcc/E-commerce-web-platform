...
type PopoverArrowPlacementGetters = {
  [arrowPlacementType in ArrowPlacementType]: {
    [arrowPlacement in ArrowPlacement]?: (args: PopoverArrowPlacementGetterArgs) => ArrowPlacementStyles;
  };
};
...
export const getArrowPlacement = ({
  ...
  arrowPlacementGetters[type][arrowPlacementGetters[type][arrowPlacement] ? arrowPlacement : defaultPlacement]({
    angle,
    arrowOffset,
  });
